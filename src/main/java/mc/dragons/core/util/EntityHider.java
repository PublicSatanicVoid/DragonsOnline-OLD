...
import static com.comphenix.protocol.Packets.Server.ADD_EXP_ORB;
import static com.comphenix.protocol.Packets.Server.ARM_ANIMATION;
import static com.comphenix.protocol.Packets.Server.ATTACH_ENTITY;
import static com.comphenix.protocol.Packets.Server.BLOCK_BREAK_ANIMATION;
import static com.comphenix.protocol.Packets.Server.COLLECT;
import static com.comphenix.protocol.Packets.Server.DESTROY_ENTITY;
import static com.comphenix.protocol.Packets.Server.ENTITY_EQUIPMENT;
import static com.comphenix.protocol.Packets.Server.ENTITY_HEAD_ROTATION;
import static com.comphenix.protocol.Packets.Server.ENTITY_LOCATION_ACTION;
import static com.comphenix.protocol.Packets.Server.ENTITY_LOOK;
import static com.comphenix.protocol.Packets.Server.ENTITY_METADATA;
import static com.comphenix.protocol.Packets.Server.ENTITY_PAINTING;
import static com.comphenix.protocol.Packets.Server.ENTITY_STATUS;
import static com.comphenix.protocol.Packets.Server.ENTITY_TELEPORT;
import static com.comphenix.protocol.Packets.Server.ENTITY_VELOCITY;
import static com.comphenix.protocol.Packets.Server.MOB_EFFECT;
import static com.comphenix.protocol.Packets.Server.MOB_SPAWN;
import static com.comphenix.protocol.Packets.Server.NAMED_ENTITY_SPAWN;
import static com.comphenix.protocol.Packets.Server.REL_ENTITY_MOVE;
import static com.comphenix.protocol.Packets.Server.REL_ENTITY_MOVE_LOOK;
import static com.comphenix.protocol.Packets.Server.REMOVE_MOB_EFFECT;
import static com.comphenix.protocol.Packets.Server.VEHICLE_SPAWN;
...
public class EntityHider implements Listener {
	...
	private static final Integer[] ENTITY_PACKETS = { 
        ENTITY_EQUIPMENT, ENTITY_LOCATION_ACTION, ARM_ANIMATION, NAMED_ENTITY_SPAWN, 
        COLLECT, VEHICLE_SPAWN, MOB_SPAWN, ENTITY_PAINTING, ADD_EXP_ORB, ENTITY_VELOCITY,
        REL_ENTITY_MOVE, ENTITY_LOOK, REL_ENTITY_MOVE_LOOK, REL_ENTITY_MOVE_LOOK, 
        ENTITY_TELEPORT, ENTITY_HEAD_ROTATION, ENTITY_STATUS, ATTACH_ENTITY, ENTITY_METADATA,
        MOB_EFFECT, REMOVE_MOB_EFFECT, BLOCK_BREAK_ANIMATION
	...
	private PacketAdapter constructProtocol(Plugin plugin) {
        return new PacketAdapter(plugin, ConnectionSide.SERVER_SIDE, ENTITY_PACKETS) {
            @Override
    ...
    public final boolean hideEntity(Player observer, Entity entity) {
        ...
        if (visibleBefore) {
            @SuppressWarnings("deprecation")
			PacketContainer destroyEntity = new PacketContainer(DESTROY_ENTITY);
